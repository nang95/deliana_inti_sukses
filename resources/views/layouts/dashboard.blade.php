...
<head>
    ...
    <!--Beyond styles-->
    <link id="beyond-link" href="{{ asset('back_assets/css/beyond.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('back_assets/css/demo.min.css') }}" rel="stylesheet" />
...
<body>
    ...
    <div class="main-container container-fluid">
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar" id="sidebar">
                <!-- Sidebar Menu -->
                @include('components.admin.sidebar_admin')
                <!-- /Sidebar Menu -->
            </div>
            <!-- /Page Sidebar -->
    ...
    <!--Beyond Scripts-->
    <script src="{{ asset('back_assets/js/beyond.js') }}"></script>
