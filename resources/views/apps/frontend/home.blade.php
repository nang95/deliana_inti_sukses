        ...
        <div class="row services-section">
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">Patner Terpercaya</h3>
          ...
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">Inovatif</h3>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
              </div>
            </div>    
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block">
              <div class="icon"><span class="flaticon-layers"></span></div>
              <div class="media-body">
                <h3 class="heading mb-3">Profesional</h3>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
              </div>
            </div>      
          </div>
									...
									<div class="select-wrap">
										<div class="icon-arr"><span class="ion-ios-arrow-down"></span></div>
											<select name="" id="" class="form-control" style="color: black">
												...
												<option value="">My Building</option>
												<option value="">My Home</option>
												<option value="">MY Office</option>
												<option value="">My Life</option>
												<option value="">My Electrical And Mechanical</option>
											</select>
										</div>
									</div>
			    				</div>
    			...
    			<div class="col-md-6 col-lg-8 pl-lg-5 py-5">
    				<div class="row justify-content-start pb-3">
						<div class="col-md-12 heading-section ftco-animate">
							...
							<h2 class="mb-4">Berdiri Sejak 2018</h2>
							<p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
						...
						<div class="item">
							<div class="project">
								<div class="img">
									...
									<a href="{{ asset('images/project-1.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
						...
						<div class="item">
							<div class="project">
								<div class="img">
									...
									<a href="{{ asset('images/project-2.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
										<span class="icon-expand"></span>
									</a>
								</div>
								<div class="text px-4">
						...
						<div class="item">
							<div class="project">
								<div class="img">
									...
									<a href="{{ asset('images/project-3.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
										<span class="icon-expand"></span>
									</a>
								</div>
								<div class="text px-4">
						...
						<div class="item">
							<div class="project">
								<div class="img">
									...
									<a href="{{ asset('images/project-4.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
										<span class="icon-expand"></span>
									</a>
								</div>
								<div class="text px-4">
						...
						<div class="item">
							<div class="project">
								<div class="img">
									...
									<a href="{{ asset('images/project-5.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
										<span class="icon-expand"></span>
									</a>
								</div>
								<div class="text px-4">
						...
						<div class="item">
							<div class="project">
								<div class="img">
									...
									<a href="{{ asset('images/project-6.jpg') }}" class="icon image-popup d-flex justify-content-center align-items-center">
										<span class="icon-expand"></span>
									</a>
								</div>
								<div class="text px-4">
    	...
    	<div class="container-fluid p-0">
    		<div class="row no-gutters justify-content-center pb-5">
				<div class="col-md-12 heading-section text-center ftco-animate">
					...
					<h2 class="mb-4">Kami Punya Tim Yang Hebat</h2>
					<p>Dibalik keberhasilan kami ada tim yang hebat.</p>
				</div>
        	</div>
			<div class="row no-gutters">
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url({{ asset('images/team-2.jpg') }});"></div>
						</div>
						<div class="text d-flex align-items-center pt-3 text-center">
							<div>
								<span class="position mb-2">Architect</span>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url({{ asset('images/team-3.jpg') }});"></div>
						</div>
						<div class="text d-flex align-items-center pt-3 text-center">
							<div>
								<span class="position mb-2">Architect</span>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="staff">
						<div class="img-wrap d-flex align-items-stretch">
							<div class="img align-self-stretch" style="background-image: url({{ asset('images/team-4.jpg') }});"></div>
						</div>
						<div class="text d-flex align-items-center pt-3 text-center">
							<div>
								<span class="position mb-2">Architect</span>
      	...
      	<div class="container">
			<div class="row justify-content-center mb-5 pb-5">
				<div class="col-md-7 heading-section text-center ftco-animate">
					<span class="subheading">Bisnis Kami</span>
					<h2 class="mb-4">Kami memiliki 5 Bisnis</h2>
					<p>Produk dan Pelayanan, PT. Deliana Inti Sukses terdiri dari 5 acam bidang</p>
				</div>
			</div>
			<div class="row d-flex">
